        ...
        <>
          ...
          {toggleQuickadd && (
            <div
              ...
              className="w-full h-full fixed md:hidden z-20  left-0 top-0"
            >
              <div className="md:hidden fixed z-20 p-3  shadow-lg rounded-t-lg bottom-0 left-0 w-full bg-white">
                <AddTask setToggleQuickadd={setToggleQuickadd} />
              </div>
            </div>
          )}
